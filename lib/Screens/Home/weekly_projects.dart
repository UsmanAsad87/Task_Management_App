...
class WeeklyProjects extends StatefulWidget {
  const WeeklyProjects({Key? key}) : super(key: key);

  @override
  State<WeeklyProjects> createState() => _WeeklyProjectsState();
}

class _WeeklyProjectsState extends State<WeeklyProjects> {
  @override
